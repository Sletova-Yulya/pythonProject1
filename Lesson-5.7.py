...
with open('Firms.txt', 'r') as firms_file:
    firm_dict = {}
    profit_list = []
    for line in firms_file:
        name, kind, earnings, costs = line.split()
    ...
    firms_list = [firm_dict, average_dict]
    with open('Firms.json', 'w') as fir_f:
        json.dump(firms_list, fir_f)
